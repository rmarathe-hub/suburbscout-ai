#!/usr/bin/env python3
"""Generate app/evals/holdout_150_v4_prompts.json — Holdout Set #4."""
...
OUT = SERVICE_ROOT / "app" / "evals" / "holdout_150_v4_prompts.json"
...
# (category, expected_intent, prompt)
...
def main() -> None:
    ...
    payload = {
        "description": "Holdout Set #4 — fresh 150 prompts (fourth phrasing variant)",
